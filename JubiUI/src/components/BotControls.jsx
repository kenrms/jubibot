...
const RefreshIcon = styled(FaSync)`
    animation: ${props => (props.isLoading ? spinAnimation : 'none')} 1s linear infinite;
    cursor: pointer;
...
function BotControls() {
    ...
    return (
        <div>
            ...
            <ControlGroup>
                <Button onClick={startBot} disabled={status}>Start Bot</Button>
                <Button onClick={stopBot} disabled={!status}>Stop Bot</Button>
            </ControlGroup>
